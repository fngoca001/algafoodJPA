...
public class RestauranteController {
	...
	public ResponseEntity<Restaurante> buscar(@PathVariable Long restauranteId) {
		Optional<Restaurante> restaurante = restaurantesRepository.findById(restauranteId);
	...
	public ResponseEntity<?> atualizar(@PathVariable Long restauranteId, @RequestBody Restaurante restaurante) {
		...
		try {
			Optional<Restaurante> restauranteAtual = restaurantesRepository.findById(restauranteId);
	...
	ResponseEntity<?> atualizarParcial(@PathVariable Long restauranteId, @RequestBody Map<String, Object> campos) {
